 ...
 */
export const text = {
  light: createPaletteChannel({ primary: '#FFFFFF', secondary: '#B9C4C0', disabled: '#7F8F8B' }),
  dark: createPaletteChannel({ primary: '#FFFFFF', secondary: '#B9C4C0', disabled: '#7F8F8B' }),
};

export const background = {
  light: createPaletteChannel({ paper: '#122422', default: '#0E1E1D', neutral: '#17302D' }),
  dark: createPaletteChannel({ paper: '#122422', default: '#0E1E1D', neutral: '#17302D' }),
};

export const action = (_mode: 'light' | 'dark'): Partial<TypeAction> => ({
  active: grey[300],
  hover: varAlpha(grey['300Channel'], 0.08),
  selected: varAlpha(grey['300Channel'], 0.14),
  focus: varAlpha(grey['300Channel'], 0.2),
  disabled: varAlpha(grey['300Channel'], 0.55),
  disabledBackground: varAlpha(grey['300Channel'], 0.12),
  hoverOpacity: 0.08,
...
export const extendPalette: PaletteExtend = {
  shared: {
    inputUnderline: varAlpha(grey['300Channel'], opacity.inputUnderline),
    inputOutlined: varAlpha(grey['300Channel'], 0.2),
    paperOutlined: varAlpha(grey['300Channel'], 0.16),
    buttonOutlined: varAlpha(grey['300Channel'], 0.32),
  },
};
...
const basePalette: ColorSystemOptions['palette'] = {
  ...
  common,
  grey,
  divider: varAlpha(grey['300Channel'], 0.16),
  TableCell: { border: varAlpha(grey['300Channel'], 0.16) },
  ...extendPalette,
};
